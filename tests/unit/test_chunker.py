...
async def test_chunk_simple_nda():
    ...
    metadata, structural_map, text = await parse_contract(str(file_path), "Test NDA")
...
async def test_chunk_saas_agreement():
    ...
    metadata, structural_map, text = await parse_contract(str(file_path), "SaaS Test")
...
async def test_chunk_vendor_agreement():
    ...
    metadata, structural_map, text = await parse_contract(str(file_path), "Vendor Test")
...
async def test_token_counts_within_limits():
    ...
    file_path = FIXTURES_DIR / "saas_agreement.md"
    _, structural_map, text = await parse_contract(str(file_path), "Token Test")
...
async def test_structural_path_populated():
    ...
    file_path = FIXTURES_DIR / "nda_simple.md"
    _, structural_map, text = await parse_contract(str(file_path), "Path Test")
...
async def test_section_type_tags_assigned():
    ...
    file_path = FIXTURES_DIR / "saas_agreement.md"
    _, structural_map, text = await parse_contract(str(file_path), "Tags Test")
